                                                ...
                                                <div class="elementor-element elementor-element-df59f4c elementor-widget elementor-widget-image"
                                                    ...
                                                    <div class="elementor-widget-container">
                                                        <style>
                                                            ...
                                                            src="{{ asset("wp-content/uploads/2023/01/logo-5-300x154.png") }}"
                                                            class="attachment-medium size-medium wp-image-27" alt=""
                                                            loading="lazy"
                                                            srcset="{{ asset("wp-content/uploads/2023/01/logo-5-300x154.png") }} 300w, {{ asset("wp-content/uploads/2023/01/logo-5.png") }} 500w"
                                                ...
                                                <div class="elementor-element elementor-element-714e5cd elementor-widget elementor-widget-image"
                                                    ...
                                                    <div class="elementor-widget-container">
                                                        <img width="300" height="300"
                                                            src="{{ asset("wp-content/uploads/2023/01/momra_logo-2.png") }}"
                                                            class="attachment-medium size-medium wp-image-134"
                                                            alt="" loading="lazy"
                                                            srcset="{{ asset("wp-content/uploads/2023/01/momra_logo-2.png") }} 300w, {{ asset("wp-content/uploads/2023/01/momra_logo-2-150x150.png") }} 150w"
                                                            sizes="(max-width: 300px) 100vw, 300px" />
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="elementor-element elementor-element-a633230 elementor-widget elementor-widget-image"
                                                    ...
                                                    <div class="elementor-widget-container">
                                                        <img width="259" height="300"
                                                            src="{{ asset("wp-content/uploads/2023/01/minister-pic-1-259x300.jpg") }}"
                                                            class="attachment-medium size-medium wp-image-28" alt=""
                                                            loading="lazy"
                                                            srcset="{{ asset("wp-content/uploads/2023/01/minister-pic-1-259x300.jpg") }} 259w, {{ asset("wp-content/uploads/2023/01/minister-pic-1.jpg") }} 362w"
                        ...
                        <div class="elementor-column elementor-col-33 elementor-top-column elementor-element elementor-element-041e223"
                            ...
                            <div class="elementor-widget-wrap elementor-element-populated">
                                <div class="elementor-element elementor-element-e15737f elementor-widget elementor-widget-image"
                                    ...
                                    <div class="elementor-widget-container">
                                        <img width="500" height="256" src="{{ asset("wp-content/uploads/2023/01/logo-5.png") }}"
                                            class="attachment-large size-large wp-image-27" alt="" loading="lazy"
                                            srcset="{{ asset("wp-content/uploads/2023/01/logo-5.png") }} 500w, {{ asset("wp-content/uploads/2023/01/logo-5-300x154.png") }} 300w"
                                            ...
                                            <nav class="hfe-nav-menu__layout-horizontal hfe-nav-menu__submenu-arrow"
                                                ...
                                                <ul id="menu-1-26f745b" class="hfe-nav-menu">
                                                    ...
                                                    {{-- <li id="menu-item-672"
                                                        class="menu-item menu-item-type-post_type menu-item-object-page parent hfe-creative-menu">
                                                        <a href="{{ route('news') }}"
                                                            class="hfe-menu-item {{ active_menu('news') }}">NEWS</a></li> --}}
                                                    <li id="menu-item-754"
                                                        class="menu-item menu-item-type-post_type menu-item-object-page parent hfe-creative-menu">
                                                    ...
                                                    <div class="elementor-widget-container">
                                                        <div class="hfe-site-logo">
                                                            <a data-elementor-open-lightbox=""
                                                                class='elementor-clickable' href="{{ route('index') }}">
