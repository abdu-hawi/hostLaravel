<section
    ...
    <div class="agenda-session-header">
        {{ __('agenda.Innovation Hub - Young Entrepreneurs Engagement') }}
    </div>
    {{-- 11:00 --}}
                            ...
                            <div class="elementor-icon-box-content">
                                <div class="elementor-icon-box-title">
                                    <span class="agenda-icon-box-title-span">
                                        ...
                                        <span>
                                            {{ __('agenda.Practical considerations for navigating the regulatory framework for mega infrastructure projects') }}
                                        </span>
                                    </span>
                                </div>
                            </div>
                        ...
                        <div class="elementor-icon-box-wrapper">
                            <div class="elementor-icon-box-content">
                                <div class="elementor-icon-box-title">
                                    <span class="agenda-icon-box-title-span">
                                        <span class="black-600">
                                            {{ __('agenda.Workshop 2:') }}
                                        </span><br>
                                        <span>
                                            {{ __('agenda. Developing and handling successful construction contracts') }}
                                        </span>
                                    </span>
                                </div>
                            </div>
