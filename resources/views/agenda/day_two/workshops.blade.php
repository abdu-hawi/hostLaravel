<section
    ...
    <div class="agenda-session-header">
        {{ __('agenda.Special Showcase: Sakani housing program – Facilitating Saudi Arabia’s housing needs') }}
    </div>
    {{-- 11:00 --}}
                            ...
                            <div class="elementor-icon-box-content">
                                <div class="elementor-icon-box-title">
                                    <span class="agenda-icon-box-title-span">
                                        ...
                                        <span>
                                            {{ __('agenda.Saudi Construction Code for Safety and Buildings') }}
                                        </span>
                                        <p class="blue-600">
                                            {{ __('agenda.Speakers:') }}
                                        </p>
