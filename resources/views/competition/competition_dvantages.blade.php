...
<style>
    .competition-dvantages{
        background-color: #E6F4FF;
        margin-top: 0 !important;
    }
    .competition-dvantages ul{
        display: inline-flex;
        flex-wrap: wrap;
    }
    .competition-dvantages li{
        width: 100%;
        padding: 0.5rem 0;
        text-align: center;
        list-style: none;
    ...
    .gold{
        color: #AF8A2F !important;
    }
    .competition-dvantages .icon.icon-checkmark-circle:before{
        font-weight: 700 !important;
    }
</style>
<section
class="elementor-section elementor-top-section elementor-element elementor-element-6d16f4f elementor-section-boxed elementor-section-height-default elementor-section-height-default competition-dvantages"
...
<div class="elementor-container elementor-column-gap-default">
    <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-fea083c"
        ...
        <div class="elementor-widget-wrap elementor-element-populated">
            <div class="elementor-element elementor-element-2e466af elementor-widget elementor-widget-heading"
                ...
                <div class="elementor-widget-container">
                    <h2 class="elementor-heading-title elementor-size-default">
                        {{ __('competition.competition_dvantages') }}
                    </h2>
                </div>
            </div>
            ...
            <div class="elementor-element elementor-element-e2917d5 elementor-widget">
                <div class="elementor-widget-container">
                    <ul class="elementor-icon-list-items">
                        <li class="elementor-icon-list-item">
                            ...
                            <span class="elementor-icon-list-text">
                                {{ __('competition.Present_your_business_idea') }}
                            </span>
                        </li>
                        <li class="elementor-icon-list-item">
                            <span class="elementor-icon-list-icon">
                            ...
                            <span class="elementor-icon-list-text">
                                {{ __('competition.Get_constructive_feedback') }}
                            </span>
                        </li>
                        <li class="elementor-icon-list-item">
                            <span class="elementor-icon-list-icon">
                            ...
                            <span class="elementor-icon-list-text">
                                {{ __('competition.winner_competition_will_be_awarded') }}
                            </span>
                        </li>
                        <li class="elementor-icon-list-item">
                            <span class="elementor-icon-list-icon">
                            ...
                            <span class="elementor-icon-list-text">
                                {{ __('competition.Connect_with_various_key') }}
                            </span>
                        </li>
                    </ul>
                </div>
